...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, num_classes=1001, input_size = (299,299,3), need_return_dict = False):
        ...
        # Modules
        self.conv2d_1a = BasicConv2d(input_size[-1], 32, kernel_size=3, stride=2)
        ...
        #self.conv2d_7b = BasicConv2d(2080, 512, kernel_size=1, stride=1)
        self.avgpool_1a = nn.AvgPool2d(6, count_include_pad=False)
        #self.last_linear = nn.Linear(2048, num_classes)
        #print("use 2048 size params")
        self.last_linear = nn.Linear(1536, num_classes)
        #self.last_linear = nn.Linear(4*1536, num_classes)
...
def inceptionresnetv2(num_classes=1000, pretrained='imagenet', need_return_dict = False):
    ...
    if pretrained:
        ...
        model = InceptionResNetV2(num_classes=num_classes,input_size=(256,256,1), need_return_dict = need_return_dict)
    return model
